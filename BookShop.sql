...
create table Books(
    ...
    unit_price decimal(10,2) check(price >= 0),
...
insert into Staffs(staff_name, user_name, pass_word, staff_status) values
	('Nguyen Hoang Hiep','staff1', md5('staff1'), '1'),
    ('Dinh Thanh Tuan','staff2', md5('staff2'), '1'),
	('Nguyen Van C','staff3', md5('staff3'), '1'),
    ('Dam Manh D','staff4', md5('staff4'), '2'),
    ('Hoang Duc E','staff5', md5('staff5'), '2'),
    ('Ma Van G','staff6', md5('staff6'), '2');
select * from Staffs;
...
insert into Books(book_name, publisher_ID, ISBN, publish_year, book_description, price, book_quantity, book_status) values
...
/* CREATE & GRANT USER */
-- create user if not exists 'H&T'@'localhost' identified by 'Tuannb1234';
